...
public class InsertOperation implements AuthorOperation {
	...
	public InsertOperation() {
		...
		argumentDescriptor = new ArgumentDescriptor(ARGUMENT_INSERT_SOURCE_LOCATION,
	...
	public void doOperation(AuthorAccess authorAccess, ArgumentsMap args) throws AuthorOperationException {
		...
		logger.debug("caret offset for insert: " + caretOffset);
		...
		logger.debug("sourceExpr for insert: " + sourceExpr);
		logger.debug("currentNode for insert: " + currentNode);
		logger.debug("currentNodeXpathExpr for insert: " + currentNodeXpathExpr);
		logger.debug("targetExpr for insert: " + targetExpr);
